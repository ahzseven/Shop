        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{route('shop.product.update', $product->id)}}" method="post">
                        ...
                        <div class="am-tabs-bd">
                            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                                ...
                                <div class="am-g am-margin-top">
                                    ...
                                    <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                        <select data-am-selected="{btnWidth: '100%',  btnStyle: 'secondary', btnSize: 'sm', maxHeight: 360, searchBox: 1}" name="brand_id">
                                ...
                                <div class="am-g am-margin-top">
                                    ...
                                    <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                        ...
                                        <div class="am-btn-group" data-am-button="">
                                            ...
                                            <label class="am-btn am-btn-default am-btn-xs am-round @if($product->is_hot) am-active @endif">
                                                <input type="checkbox" name="is_hot" value="1"
                                                @if($product->is_hot) checked @endif> 热销
                                            </label>
                                            <label class="am-btn am-btn-default am-btn-xs am-round @if($product->is_new) am-active @endif">
                    ...
                    <div class="am-margin am-u-sm-8 am-u-md-4 am-u-end col-end">
                        <button type="submit" class="am-u-md-8 am-btn am-btn-primary am-radius">提交保存</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(function () {
           ...
           $(".cancel").click(function(){
               ...
               $.ajax({
                   type: 'delete',
                   url: "/admin/shop/product/delete_img/"+id,
