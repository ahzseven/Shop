                        ...
                        <tr data-id="{{$role->id}}">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        @if($role->id != 1)
                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="{{route('system.role.edit', $role->id)}}">
                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                        </a>

                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="{{route('system.role.destroy', $role->id)}}" data-method="delete" data-token="{{csrf_token()}}" data-confirm="确认删除吗?">
