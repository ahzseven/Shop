                                ...
                                <div class="am-panel am-panel-default">
                                    <div class="am-panel-hd">
                                        <label class="am-checkbox-inline am-danger">
                                            <input data-am-ucheck="" type="checkbox" value="{{$permission->id}}" name="permission_id[]" class="permission1 am-ucheck-checkbox"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span>
                                    ...
                                    <div class="am-panel-bd">
                                        ...
                                        <div class="am-g am-margin-top ">
                                            <div class="am-u-sm-4 am-u-md-3 am-text-right permission-div2">
                                                <label class="am-checkbox-inline am-danger">
                                                    <input data-am-ucheck="" type="checkbox" value="{{$children->id}}" name="permission_id[]" class="permission2 am-ucheck-checkbox"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span>
                                            ...
                                            <div class="am-u-sm-8 am-u-md-9 am-u-end col-end permission-div3">
                                                ...
                                                <label class="am-checkbox-inline  am-danger">
                                                    <input data-am-ucheck="" type="checkbox" value="{{$c->id}}" class="permissions3 am-ucheck-checkbox" name="permission_id[]">
                                                    {{$c->label}}
                                                </label>
                                                    @endforeach
                                            </div>
